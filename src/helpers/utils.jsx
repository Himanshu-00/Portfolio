...
export const getInitialTheme = (themeConfig) => {
  ...
  if (
    ...
    !(localStorage.getItem('portfolio-app-theme') === null) &&
    themeConfig.themes.includes(localStorage.getItem('portfolio-app-theme'))
  ) {
    let theme = localStorage.getItem('portfolio-app-theme');
...
export const sanitizeConfig = (config) => {
  ...
  return {
    ...
    resume2: {
      fileUrl: config?.resume2?.fileUrl || '',
    },
    
    skills: config?.skills || [],
    
    themeConfig: {
      defaultTheme: config?.themeConfig?.defaultTheme || themes[2],
      themes: themes,
